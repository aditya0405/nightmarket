    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('Welcome') ?>">
                ...
                <div class="sidebar-brand-text mx-3">Night Market</sup></div>
            </a>
			...
			<li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('welcome/hadiah')?>">
				<i class="fas fa-gifts"></i>
                    <span>Tukar Hadiah</span></a>
            </li>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <div class="navbar">
							...
							<li>
								<?php $keranjang = '<i class="fas fa-coins"></i> '. ' Point'?>
								<?php echo anchor ('/dashboard/detail_keranjang',$keranjang)  ?>
							</li>	

							<li class="ml-3">
								<?php $keranjang = '<i class="fas fa-cart-plus"></i> '. $this->cart->total_items(). ' Items'?>
								<?php echo anchor ('/dashboard/detail_keranjang',$keranjang)  ?>
							</li>
